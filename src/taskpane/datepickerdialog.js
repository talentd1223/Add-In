...
DatePickerDialog.prototype.setTextboxDate = function (domNode) {
  ...
  if (domNode) {
    ...
    this.days.forEach((day) =>
      day === domNode ? day.setAttribute("aria-selected", "true") : day.removeAttribute("aria-selected")
    );
  }

  this.textboxNode.value = d.getDate() + "-" + this.monthLabels[d.getMonth()] + "-" + d.getFullYear();
  this.setDateForButtonLabel();
};
