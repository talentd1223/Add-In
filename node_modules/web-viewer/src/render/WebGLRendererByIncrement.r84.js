...
// functionality.
    ...
    function WebGLGeometriesEx( gl, properties, info,  maxDrawCacheNum) {
    ...
    function WebGLObjectsEx( gl, properties, info, maxDrawCacheNum ) {

        var geometries = new WebGLGeometriesEx( gl, properties, info, maxDrawCacheNum );
    ...
    function WebGLRendererByIncrement( parameters ) {
        ...
        if (_maxDrawCacheNum !== undefined) {
            objects = new WebGLObjectsEx( _gl, properties, this.info, _maxDrawCacheNum );
        } else {
