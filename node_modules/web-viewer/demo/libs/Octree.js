 ...
 */
 ( function ( THREE ) {
	...
	THREE.Octree.prototype = {
		...
		// Octree frustum query API - william
        searchFrustum: function ( organizeByObject, frustum ) {
            ...
            for ( i = 0, l = this.root.nodesIndices.length; i < l; i ++ ) {
                ...
                objects = node.intersectFrustum( objects, frustum );
	...
	THREE.OctreeNode = function ( parameters ) {
		...
		this.min = new THREE.Vector3(this.left, this.bottom, this.back);
		this.max = new THREE.Vector3(this.right, this.top, this.front);
	...
	THREE.OctreeNode.prototype = {
        ...
        intersectFrustum: function (objects, frustum ) {
